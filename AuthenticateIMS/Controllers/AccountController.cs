...
namespace AuthenticateIMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult Create([Bind(Include = "id,mine_number,name,role_ID")] user user)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        db.users.Add(user);
        ...
        //    ViewBag.mine_number = new SelectList(db.Employee_Details, "mine_number", "surname", user.mine_number);
        //    ViewBag.role_ID = new SelectList(db.Roles, "role_ID", "role_descriptiom", user.role_ID);
        //    return View(user);
        //}
