...
namespace IMS.Controllers
{
    ...
    public class EmployeeDetailsController : Controller
    {
        ...
        {
            var employee_Details = db.Employee_Details.Include(e => e.CustomUser);
        ...
        {
            ViewBag.mine_number = new SelectList(db.CustomUsers, "mine_number", "role_ID");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,surname,firstname,other_names,mine_number,site,department,position,job_title")] Employee_Details employee_Details)
        {
            ...
            ViewBag.mine_number = new SelectList(db.CustomUsers, "mine_number", "role_ID", employee_Details.mine_number);
            return View(employee_Details);
        }
