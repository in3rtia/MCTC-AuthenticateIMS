...
namespace AuthenticateIMS.Models
{
    ...
    public partial class StockManagementEntities : DbContext
    {
        ...
        public virtual DbSet<Approval_Rights> Approval_Rights { get; set; }
        ...
        public virtual ObjectResult<getApproverApprovedRequests_Result> getApproverApprovedRequests(Nullable<int> approval_status, string approver)
        {
            var approval_statusParameter = approval_status.HasValue ?
                new ObjectParameter("approval_status", approval_status) :
                new ObjectParameter("approval_status", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getApproverApprovedRequests_Result>("getApproverApprovedRequests", approval_statusParameter, approverParameter);
        }
    
        public virtual ObjectResult<getApproverRequests_Result> getApproverRequests(Nullable<int> approval_status, string approver)
        {
            var approval_statusParameter = approval_status.HasValue ?
                new ObjectParameter("approval_status", approval_status) :
                new ObjectParameter("approval_status", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getApproverRequests_Result>("getApproverRequests", approval_statusParameter, approverParameter);
        }
        ...
        public virtual ObjectResult<getMyOpenRequests_Result> getMyOpenRequests(string mineNumber, Nullable<int> approvalStatus)
        {
            var mineNumberParameter = mineNumber != null ?
                new ObjectParameter("mineNumber", mineNumber) :
                new ObjectParameter("mineNumber", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getMyOpenRequests_Result>("getMyOpenRequests", mineNumberParameter, approvalStatusParameter);
        }
        ...
        public virtual ObjectResult<string> getSupervisor(string mine_number)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("getSupervisor", mine_numberParameter);
        }
    
        public virtual ObjectResult<getUserCollections_Result> getUserCollections(string mine_number)
        {
            var mine_numberParameter = mine_number != null ?
                new ObjectParameter("mine_number", mine_number) :
                new ObjectParameter("mine_number", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getUserCollections_Result>("getUserCollections", mine_numberParameter);
        }
    
        public virtual ObjectResult<getUserRequests_Result> getUserRequests(Nullable<int> approval_status, string mine_number)
        {
            var approval_statusParameter = approval_status.HasValue ?
                new ObjectParameter("approval_status", approval_status) :
                new ObjectParameter("approval_status", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getUserRequests_Result>("getUserRequests", approval_statusParameter, mine_numberParameter);
        }
        ...
        public virtual int insertRequest(string request_ID, string stock_code, string compartment_ID, string purpose_of_item, string mine_number, string date_of_request, Nullable<int> quantity, string unit_of_issue, Nullable<int> approval_status, string approver, Nullable<System.DateTime> expected_date, Nullable<int> workflow_ID)
        {
            var request_IDParameter = request_ID != null ?
                new ObjectParameter("request_ID", request_ID) :
                new ObjectParameter("request_ID", typeof(string));
            ...
            var workflow_IDParameter = workflow_ID.HasValue ?
                new ObjectParameter("workflow_ID", workflow_ID) :
                new ObjectParameter("workflow_ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("insertRequest", request_IDParameter, stock_codeParameter, compartment_IDParameter, purpose_of_itemParameter, mine_numberParameter, date_of_requestParameter, quantityParameter, unit_of_issueParameter, approval_statusParameter, approverParameter, expected_dateParameter, workflow_IDParameter);
        }
        ...
        public virtual ObjectResult<ApproverRejectedRequests_Result> ApproverRejectedRequests(Nullable<int> approval_status, string approver)
        {
            var approval_statusParameter = approval_status.HasValue ?
                new ObjectParameter("approval_status", approval_status) :
                new ObjectParameter("approval_status", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ApproverRejectedRequests_Result>("ApproverRejectedRequests", approval_statusParameter, approverParameter);
        }
    
        public virtual ObjectResult<getApproverRejectedRequests_Result> getApproverRejectedRequests(Nullable<int> approval_status, string approver)
        {
            var approval_statusParameter = approval_status.HasValue ?
                new ObjectParameter("approval_status", approval_status) :
                new ObjectParameter("approval_status", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getApproverRejectedRequests_Result>("getApproverRejectedRequests", approval_statusParameter, approverParameter);
        }
    }
}
