...
namespace AuthenticateIMS.Models
{
    ...
    public partial class StockManagementEntities : DbContext
    {
        ...
        public virtual int insertRequest(string request_ID, string stock_code, string compartment_ID, string purpose_of_item, string mine_number, string date_of_request, Nullable<int> quantity, string unit_of_issue, Nullable<int> approval_status, string approver)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("insertRequest", request_IDParameter, stock_codeParameter, compartment_IDParameter, purpose_of_itemParameter, mine_numberParameter, date_of_requestParameter, quantityParameter, unit_of_issueParameter, approval_statusParameter, approverParameter);
        }
